...
<html>
	<head>
		...
		<spring:url value="/resources/plugins/jvectormap/jquery-jvectormap-1.2.2.css" var="jvectormapCSS" />
		<spring:url value="/resources/dist/css/AdminLTE.min.css" var="AdminLteCSS" />
		<spring:url value="/resources/dist/css/skins/_all-skins.min.css" var="skinAllCSS" />
		
		
		
		<spring:url value="/resources/plugins/jQuery/jquery-2.2.3.min.js" var="jqueryJS" />
		...
		<spring:url value="/resources/dist/js/app.min.js" var="appJS" />
		...
		<spring:url value="/resources/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" var="jvectormapWorldJS" />
		<spring:url value="/resources/plugins/slimScroll/jquery.slimscroll.min.js" var="slimScrollJS" />
		<spring:url value="/resources/plugins/plugins/chartjs/Chart.min.js" var="chartjsJS" />
		<spring:url value="/resources/dist/js/pages/dashboard2.js" var="dashboard2JS" />
		...
		<link href="${jvectormapCSS}" rel="stylesheet" />
		<link href="${AdminLteCSS}" rel="stylesheet" />
		<link href="${skinAllCSS}" rel="stylesheet" />
...
<div class="wrapper">
  ...
  <div class="control-sidebar-bg"></div>
		...
		<script src="${jvectormapWorldJS}"></script>
		<script src="${slimScrollJS}"></script>
		<script src="${chartjsJS}"></script>
		
		<script src="${dashboard2JS}"></script>
